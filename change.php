...
<div class="container">
  	...
  	<div class="changeContent">
        ...
        <form id="changeForm" method="post" action="#">
        	<label>Old Password: <input type="password" id="pass" name="pass" /></label>
            <label>New Password: <input type="password" id="newPass" name="newPass" /></label>
            <label>Verify Password: <input type="password" id="verPass" name="verPass" /></label>
            <label><input type="submit" value="Change Password" id="login" name="login" /></label>
            <label><button style="float: right;" type="submit" value="back" id="back" name="back">Back</button></label>
        </form>
        </div><!-- end .loginHolder -->
