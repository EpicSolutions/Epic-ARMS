...
<div id="insideContainer">
  ...
  <div class="content" style="border: none;">
  	<form id="mailListForm" action="maillist.php">
    <title>Mailing List Maintenance</title>
    	...
    	<p>Add or remove addresses from Mailing List</p>
			...
			<label style="display: inline;">Add to Do Not Mail List<input type="radio" class="mailRadio" name="type" value="remove" /></label>
        
        <br />
        
        <label>Address 
        	<input type="input" style="margin-left: 20px;" id="address" size="50" name="address" />
        </label>
        ...
        <input type="submit" id="viewRemove" name="viewRemove" value="View Removal List" />
