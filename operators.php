...
<div id="insideContainer">
	...
	<div class="content">
		<img id="mainMap" src="images/map.png" />
        	<ul class="verticalButton" id="greenButton">
            	<a href="manageusers.php"><li>Manage Users</li></a>
                <a href="mailinglist.php"><li>Maintain Mailing List</li></a>
                <a href="callreport.php"><li>Create Call Report</li></a>
                <a href="callin.php"><li>Schedule Call-In</li></a>
                <a href="addcustomer.php"><li>Add Customer</li></a>
                <a href="routeresults.php"><li>Route Results</li></a>
            </ul>   
	</div><!-- end .content -->
